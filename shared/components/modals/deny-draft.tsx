...
const DenyDraft = ({
    ...
    const handleFinish = (values: any) => {
        ...
        denyDraft.mutate(values)
    }
    return (
        <>
            <Modal confirmLoading={isConfirmLoading} width={800} closable={true} title="Phiêu yêu cầu xử lý văn bản đến" open={isOpen} onOk={handleOk} onCancel={handleCancel}>
                <Form
                    form={form}
                    layout="vertical"
                    style={{ maxWidth: 1200 }}
